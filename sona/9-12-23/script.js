...
//  օգտագորել տրամաբանական կտորների լուծման համար, մեկ էլ սա մի փոքր դուրս չեկավ event.target.nextSibling,  container -ը
//  լավ կլինի օգտագործենք մենակ user -ների համար input էլ  դնենք իրանից դուրս:
